...
runuser -u vk9587 -- ssh-keygen -q -t rsa -f /users/vk9587/.ssh/id_rsa -N ''
...
cp /users/vk9587/.ssh/id_rsa* /var/nfs/keys
...
# setup lamp
runuser -u vk9587 -- bash /local/repository/setup_ansible.sh
